...
typedef struct {
		u32 dynClkAddr;                     /* Physical Base address of the dyanmic clock core*/
		XAxiVdma *vdma;                     /* video DMA driver struct*/
		XAxiVdma_DmaSetup vdmaConfig;       /* video DMA channel configuration*/
		XVtc vtc;                           /* video timing controller driver struct*/
...
int DisplayInitialize(DisplayCtrl *dispPtr, XAxiVdma *vdma, u32 vtcAddr, u32 dynClkAddr, u8 *framePtr[DISPLAY_NUM_FRAMES], u32 stride);
