...
// follow this instead: https://github.com/Xilinx/embeddedsw/blob/master/XilinxProcessorIPLib/drivers/scutimer/examples/xscutimer_polled_example.c
...
int TimerInitialize(XScuTimer *TimerInstancePtr, UINTPTR BaseAddress)
{
	 ...
	 */
	ConfigTmrPtr = XScuTimer_LookupConfig(BaseAddress);
	 ...
	 * Set prescaler to 1
	 */
    // prescaler divides the input clock frequency to the timer
